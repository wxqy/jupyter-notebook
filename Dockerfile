...
RUN http --download https://julialang-s3.julialang.org/bin/linux/x64/1.0/julia-1.0.0-linux-x86_64.tar.gz
ENV PATH="/opt/julia-1.0.0/bin:${PATH}"
#RUN julia -e "ENV[\"jupyter\"]=\"$(which jupyter)\"; using Pkg; Pkg.add(\"IJulia\")"
